...
type OptionsSrc struct {
	...
	Sniffer struct {
		...
		Interval       conf_time.Duration `json:"interval"`
		Timeout        conf_time.Duration `json:"timeout"`
		TimeoutStartup conf_time.Duration `json:"timeout_startup"`
	} `json:"sniffer"`
	HealthCheck struct {
		Enabled        bool               `json:"enabled"`
		Interval       conf_time.Duration `json:"interval"`
	...
	Retrier struct {
		...
		Timeout    conf_time.Duration `json:"timeout"`
		TimeoutMin conf_time.Duration `json:"timeout_min"`
		TimeoutMax conf_time.Duration `json:"timeout_max"`
	} `json:"retrier"`
}
